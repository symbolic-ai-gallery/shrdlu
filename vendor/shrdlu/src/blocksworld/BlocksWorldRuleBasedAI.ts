	...
	update(timeStamp:number) 
	{
        ...
        if (this.currentActionHandler != null &&
        	...
        	if (this.currentActionHandler.executeContinuous(this)) {
				...
				const completedActionHandler = this.currentActionHandler;
				...
				// }			
				if (!completedActionHandler.ir.succeeded) {
					this.removeQueuedPerformativesDependingOnIntentionSuccess(completedActionHandler.ir);
				}
        	}
        }
